...
export default function BlueLockS2() {
  return (
    <div>
    <Layout title={"Descargar Blue Lock S2 - Vs. U-20 Japan - Sub. Español - 06/14"}
    description="Lista de Series Animadas en Español " imageog={"/img/bluelocks2banner.jpg"}>
      ...
      <div className="container"><br /><br /><br /><br />
          <div className="row">
            ...
            <h1 className="textlist">⟱ Blue Lock S2 - Vs. U-20 Japan - Enlaces de Descarga - 06/14 :</h1><br /><br /><br />
            <div className="row">
            ...
            <h1 className="textlist">☰ Blue Lock S2 - Vs. U-20 Japan - Lista de Capitulos - 06/14 :</h1><br /><br /><br />
            <div className="row">
              <div className="col-md-3 col-sm-6 col-12">
                <div className="card"> <Image alt=" " width="100%" height="56" layout="responsive" src={"/img/caps/blocks2cap01.jpg"} />
                  <h2 className="fontcap"> CAP 1 </h2> <a href={"https://filemoon.sx/d/ccn559lqun4v"} rel="noopener noreferrer" target="_blank">
              ...
              <div className="col-md-3 col-sm-6 col-12">
                <div  className="card"> <Image alt=" " width="100%" height="56" layout="responsive" src={"/img/caps/blocks2cap02.jpg"} />
                  <h2 className="fontcap"> CAP 2 </h2> <a href={"https://filemoon.sx/d/57if2zt2c0vu"} rel="noopener noreferrer" target="_blank">
                  <div className="overlay"> <h2 className="fontgr">‣ </h2> </div> </a>
                </div>
              </div>
              <div className="col-md-3 col-sm-6 col-12">
                <div  className="card"> <Image alt=" " width="100%" height="56" layout="responsive" src={"/img/caps/blocks2cap03.jpg"} />
                  <h2 className="fontcap"> CAP 3 </h2> <a href={"https://filemoon.sx/d/k0472vuf4pum"} rel="noopener noreferrer" target="_blank">
                  <div className="overlay"> <h2 className="fontgr">‣ </h2> </div> </a>
                </div>
              </div>
              <div className="col-md-3 col-sm-6 col-12">
                <div  className="card"> <Image alt=" " width="100%" height="56" layout="responsive" src={"/img/caps/blocks2cap04.jpg"} />
                  <h2 className="fontcap"> CAP 4 </h2> <a href={"https://filemoon.sx/d/oawdzvw605r6"} rel="noopener noreferrer" target="_blank">
                  <div className="overlay"> <h2 className="fontgr">‣ </h2> </div> </a>
                </div>
              </div>
              <div className="col-md-3 col-sm-6 col-12">
                <div  className="card"> <Image alt=" " width="100%" height="56" layout="responsive" src={"/img/caps/blocks2cap05.jpg"} />
                  <h2 className="fontcap"> CAP 5 </h2> <a href={"https://filemoon.sx/d/peyzii8jip1l"} rel="noopener noreferrer" target="_blank">
                  <div className="overlay"> <h2 className="fontgr">‣ </h2> </div> </a>
                </div>
              </div>
              <div className="col-md-3 col-sm-6 col-12">
                <div  className="card"> <Image alt=" " width="100%" height="56" layout="responsive" src={"/img/caps/blocks2cap06.jpg"} />
                  <h2 className="fontcap"> CAP 6 </h2> <a href={"https://filemoon.sx/d/b81djvo6soxo"} rel="noopener noreferrer" target="_blank">
                  <div className="overlay"> <h2 className="fontgr">‣ </h2> </div> </a>
                </div>
              </div>
